<template>
  <div class="page modern business managed-services-page colocation-page">
    <header class="header">
        ...
        <section class="hero hero--fullbleed">
          <div class="hero__inner hero__inner--modern-simple">
            <div class="hero__content">
              <p class="hero__eyebrow">Colocation &amp; Housing</p>
              <h1 class="hero__title">Colocation &amp; Housing</h1>
              <p class="hero__subtitle">
                Unser Sicherheits-Rechenzentrum in Hannover bietet Ihnen alle Voraussetzungen für den wirtschaftlichen und
                sicheren Betrieb Ihrer IT-Systeme und/oder die Speicherung Ihrer Unternehmensdaten.
              </p>
            </div>
          ...
          <div class="managed-ms-frame managed-ms-frame--why">
            <article class="modern-service-card managed-ms-card managed-ms-card--why">
              <div class="managed-ms-why">
                <div class="managed-ms-why__features" aria-label="Themen">
                  <div class="managed-ms-feature">
                    ...
                    <h3 class="managed-ms-feature__title">Rechenzentrum</h3>
                    <p class="managed-ms-feature__text">
                      Unser Sicherheits-Rechenzentrum in Hannover bietet Ihnen alle Voraussetzungen für den wirtschaftlichen
                      und sicheren Betrieb Ihrer IT-Systeme und/oder die Speicherung Ihrer Unternehmensdaten.
                    </p>
                  </div>
                  ...
                  <div class="managed-ms-feature">
                    ...
                    <h3 class="managed-ms-feature__title">Preismodell</h3>
                    <p class="managed-ms-feature__text">
                      Wir unterstützen Sie bei der Umsetzung Ihrer individuellen Housing-Anforderungen. Unser Preismodell sorgt
                      von Beginn an für die notwendige Kostenübersicht zur optimalen Planung Ihrer IT-Budgets.
                    </p>
                  </div>
                  ...
                  <div class="managed-ms-feature">
                    ...
                    <h3 class="managed-ms-feature__title">Kundenvorteile</h3>
                    <p class="managed-ms-feature__text">
                      Neben geringeren Investitions- und Betriebskosten zählen vor allem die erstklassige Konnektivität,
                      umfassende Management- und Service-Leistungen und die erhöhte Datensicherheit zu den Vorteilen des
                      Housing/Colocation bei uns.
                    </p>
                  </div>
                  ...
                  <div class="managed-ms-feature">
                    ...
                    <h3 class="managed-ms-feature__title">Services</h3>
                    <p class="managed-ms-feature__text">
                      Professionelles Outsourcing mit voller Hard- &amp; Softwarekontrolle spart bares Geld! In unserem
                      Rechenzentrum können Sie Ihr eigenes Equipment betreiben, sei es ein ganzes IT-System, ein einzelner
                      Server oder ein halbes oder ganzes Rack.
                    </p>
                  </div>
                  ...
                  <div class="managed-ms-feature">
                    ...
                    <h3 class="managed-ms-feature__title">Qualitätsmanagement</h3>
                    <p class="managed-ms-feature__text">
                      Unser wichtigstes Unternehmensziel ist die maximale Kundenzufriedenheit. Anerkannte Auditierungen und
                      Zertifizierungen gewährleisten die gleichbleibende und nachvollziehbare Qualität unserer Services.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <article class="modern-service-card managed-ms-card managed-ms-card--split">
              <div class="managed-ms-split">
                ...
                <div class="managed-ms-split__content">
                  <h2 class="managed-ms-card__title">Colocation, die Ausfälle verhindert</h2>
                  <p class="modern-service-card__text">
                    Redundante Stromversorgung, kontrollierte Umgebungsbedingungen und 24/7-Überwachung sichern Ihre Hardware
                    im Datacenter ab – planbar und nachvollziehbar.
                  </p>

                  <div class="managed-ms-split__actions">
                    <a
                      class="btn managed-ms-btn managed-ms-btn--blue"
                      href="mailto:vertrieb@grass-merkur.de?subject=Colocation%20%26%20Housing"
                    >
                      Colocation-Angebot anfragen
                    </a>
                  </div>

                  <div class="managed-ms-split__divider" aria-hidden="true"></div>

                  <h3 class="managed-ms-card__subtitle">Hybrid IT anschließen</h3>
                  <p class="modern-service-card__text">
                    Verbinden Sie Ihre Colocation mit Private- und Public-Cloud – über Cross-Connects, Peering und
                    sichere Netzwerksegmente.
                  </p>
                  <div class="managed-ms-split__actions">
                    <a
                      class="btn managed-ms-btn managed-ms-btn--ghost"
                      href="mailto:vertrieb@grass-merkur.de?subject=Connectivity%20%26%20Cross-Connects"
                    >
                      Anbindung &amp; Cross-Connects
                    </a>
                  </div>

                  <div class="managed-ms-split__divider" aria-hidden="true"></div>

                  <h3 class="managed-ms-card__subtitle">Geprüft. Ausgezeichnet.</h3>
                  <p class="modern-service-card__text">
                    Unsere Zertifizierungen und Audits liefern Ihnen die Nachweise für Compliance, Prozesse und
                    Sicherheitsstandards.
                  </p>
                  <div class="managed-ms-split__actions">
                    <a class="btn managed-ms-btn managed-ms-btn--ghost" href="/zertifizierungen">
          ...
          <div class="managed-ms-frame managed-ms-frame--contact">
            <article class="modern-service-card managed-ms-card managed-ms-card--contact">
              ...
              <p class="managed-ms-card__lead">
                Von der Flächenplanung bis zum Betrieb: feste Ansprechpartner, kurze Wege und klare Verantwortung.
              </p>
              ...
              <div class="managed-ms-contact">
                ...
                <div class="managed-ms-contact__actions">
                  <a
                    class="btn managed-ms-btn managed-ms-btn--blue"
                    href="mailto:markus.dietz@grass-merkur.de?subject=Colocation%20%26%20Housing"
                  >
                    Kontakt aufnehmen
                  </a>
                </div>
...
import './styles/pages/colocation.css'
