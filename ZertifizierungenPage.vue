    ...
    <header class="header">
      <div class="header__inner">
        <div class="header__brand">
          ...
          <div class="header__tagline">Nachweise für Sicherheit, Energie & Verantwortung</div>
        </div>
      ...
      <div class="section-shell section-shell--hero">
        <section class="hero cert-page__hero">
          <div class="hero__content">
            <p class="hero__eyebrow">Auditierte Qualität</p>
            <h1 class="hero__title">Transparente Zertifizierungen für Ihr Compliance-Team</h1>
            <p class="hero__subtitle">
              Informationssicherheit, Umwelt und Energieeffizienz werden fortlaufend durch unabhängige Auditor:innen bestätigt.
              Jede Urkunde steht zum Nachweis für Ausschreibungen oder Vendor-Assessments bereit.
            </p>
      ...
      <div class="section-shell section-shell--flush">
        <section class="section section--flush cert-page__certs">
          <div class="section__header">
            <h2 class="section__title">Unsere aktuellen Zertifizierungen</h2>
            <p class="section__subtitle">
              Jede Urkunde ist inklusive Gültigkeitszeitraum, Prüfinstitut und konkreten Anwendungsbereichen dokumentiert.
            </p>
          </div>
      ...
      <div class="section-shell section-shell--flush">
        <section class="section section--alt section--flush cert-proof">
          <div class="cert-proof__panel">
            <p>
              Ausführliche Details zum Thema <span class="cert-proof__highlight">„Datenschutz“</span> und zur
              <span class="cert-proof__highlight">„Datensicherheit“</span> finden Sie in den folgenden Dokumenten:
            </p>
            <ul>
              <li>
                Leitlinie
...
import './styles/pages/zertifizierungen.css'
